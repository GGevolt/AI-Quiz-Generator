...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (generateQuizButton) {
    ...
    generateQuizButton.addEventListener('click',  debounce(function () {
      ...
      const prompt = `Generate a quiz about ${themeInput} in ${languageInput}. The quiz should contain 10 ${difficultyInput} questions. Each question should have 4 possible answers, and only one of them should be correct. Indicate the correct answer and provide an explanation for the correct answer.`;
